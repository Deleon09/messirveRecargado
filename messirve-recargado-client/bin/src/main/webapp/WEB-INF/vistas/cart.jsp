				...
				$( ".deleteFromCart" ).click(function(){
					  ...
					  $.ajax({
		                    ...
		                    success: function (response) {
		                        Swal.fire(
							      'Eliminado!',
							      'Se elimino el item del carrito.',
							      'success'
							    )
    ...
    <body>
        ...
        <div class="container p-3" style="font-family: 'Roboto', sans-serif;">         
			...
			<div class="row">
				...
				<div class="col-lg-4">
					<a href="/shop" type="button" style="width: 100%; background-color: #1F69FF; font-family: 'Roboto', sans-serif;" class="btn text-white">Buy</a>
				</div>
				<div class="col-lg-4">
