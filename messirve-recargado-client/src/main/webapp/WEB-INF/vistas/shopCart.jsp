        ...
        <script>
            $(document).ready(function(){
        		...
        		document.getElementById("payForm").addEventListener("submit", function(event){
					...
					var p_total = $(".priceValue").val();
		  			
		  			if(userInfo){
		  				var shoppinDetails = {
		  					user: userInfo.id,
		  					direccion_orden: address,
							precio_total_orden: p_total,		  					
							metodo_pago_orden: "Tarjeta",		  					
							pagada_orden: true,
							enviada_orden: true,													
		  				}
		  				...
		  				$.ajax({
		                    data: shoppinDetails,
		                    url: '${pageContext.request.contextPath}/guardarOrden',
		                    type: "POST",
			...
			<div style="background-color: #F0F2FE; -webkit-box-shadow: 5px 5px 0px 0px #289FED, 10px 10px 0px 0px #5FB8FF, 15px 15px 0px 0px #A1D8FF, 20px 20px 0px 0px #CAE6FF, 25px 25px 0px 0px #E1EEFF, 10px 10px 27px 5px rgba(0,0,0,0); 
				...
				<div class="row p-4" style="font-family: 'Roboto', sans-serif;">
					<div class="col-lg-7"  style="font-family: 'Roboto', sans-serif;">
						<h3 style="color: #1F69FF; font-weight: 900;">Shopping</h3>
						<p style="color: black;">This is the total of your purchase, enter the data to make the payment.</p>
						<form id="payForm">
							<div class="row mb-3">
								<div class="col-lg-12">
                            ...
                            <div class="row mb-3">
								<div class="col-lg-12">
									<input class="form-control form-control-lg" required type="text" id="Address" placeholder="Address" aria-label=".form-control-lg example">
								</div>
							</div>
                            <div class="row mb-3">
								<div class="col-lg-12">
									<input readonly class="priceValue form-control form-control-lg" required type="number" value="${priceShop}" aria-label=".form-control-lg example">
								</div>
							</div>
							<div class="row mb-3">
								<div class="col-lg-12">
