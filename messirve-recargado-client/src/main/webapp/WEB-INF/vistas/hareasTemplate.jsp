    ...
    <script>
    	$(document).ready(function(){
    		...
    		document.getElementById("formHar").addEventListener("submit", function(event){
				  ...
				  confirmButtonText: 'Yes, add a new register!'
				}).then((result) => {
	  				if (result.value) {
...
<body style="background-color: #F5F6F8;">
    ...
    <div style="margin-left: 265px;">
         <h1 class="d-block fw-bold" style="color: #1F69FF; padding-top: 50px; margin-left: 64px; margin-right: 1em;">Hospital areas</h1>
			  ...
			  <tbody>
			  	<c:forEach items="${hareas}" var="harea">     
		   			<tr style="border-bottom: 1px solid; border-color: #cacaca;">                               
                		...
                		<td>
                			<a href="/editarHarea/${harea.id}" type="button" style="background-color: #109CF1; color:#FFFFFF; border:none; padding: 10px 40px;">Edit</a>
