                    	...
                    	table = $('#rolesList').DataTable({
                        	...
                        	"columns": [
                        		{ data: 'nombre' },
                        		{
                        			...
                        			{
                        				return '<a href="/editarRol/'+ data.id +'" type="button" style="background-color: #109CF1; color:#FFFFFF; border:none; padding: 10px 40px;">Edit</a> <button type="button" id="'+ data.id +'" class="eliminarRol btn btn-danger"><i class="fa-solid fa-trash"></i></button>';
                        			}
                        		}
                        	]
                        });
...
<body style="background-color: #F5F6F8;">
    ...
    <div style="margin-left: 265px;">
         <h1 class="d-block fw-bold" style="color: #1F69FF; padding-top: 50px; margin-left: 64px; margin-right: 1em;">Roles</h1>
         ...
         <div class="form-floating mb-4 position-relative">         
            ...
            <table id="rolesList" class="text-center" style="background-color: #FFFFFF; margin-top:2em; box-shadow: 0px 0px 5px 0px rgba(0,0,0,0.30); -webkit-box-shadow: 0px 0px 5px 0px rgba(0,0,0,0.30); -moz-box-shadow: 0px 0px 5px 0px rgba(0,0,0,0.30);">
              <thead>
