    ...
    <body>
        ...
        <div class="container p-3">         
			...
			<!-- SINGLE PRODUCT SECTION START -->
				...
				<div class="my-3" style="background-color: #F0F2FE; -webkit-box-shadow: 5px 5px 0px 0px #289FED, 10px 10px 0px 0px #5FB8FF, 15px 15px 0px 0px #A1D8FF, 20px 20px 0px 0px #CAE6FF, 25px 25px 0px 0px #E1EEFF, 10px 10px 27px 5px rgba(0,0,0,0); 
